                ...
                <div class="card-body">
                    ...
                    <div class="form-group clearfix">
                        <div class="icheck-primary d-inline" style="padding-right:20px">
                            <input type="radio" name="faq_type"" id="faq_type0" {{ old('faq_type', $faq->faq_type) == '0' ? 'checked' : '' }} value="0">
                            <label>{{ __('messages.faq_home') }}</label>
                        </div>
                        <div class="icheck-primary d-inline">
                            <input type="radio" name="faq_type" id="faq_type1" {{ old('faq_type', $faq->faq_type) ? 'checked' : '' }} value="1">
