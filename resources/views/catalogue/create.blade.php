...
@section('content_header')
    <h1>{{__('messages.new_catalogue')}}</h1>
@stop
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="cata_description" id="cata_description"
                            class="form-control @error('cata_description') is-invalid @enderror">{{ old('cata_description') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        {{-- <input type="file" name="cata_image" id="cata_image"
                            class="form-control-file 
                            @error('cata_image') is-invalid @enderror"
                    ...
                    {{-- <div class="form-group">
                        ...
                        <input type="url" name="cata_url" id="cata_url"
                            class="form-control @error('cata_url') is-invalid @enderror" value="{{ old('cata_url') }}" placeholder="{{ asset('/') }}">
                        @error('cata_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div> --}}
