...
Route::group(['middleware' => ['auth', 'permission']], function(){
    ...
    Route::post('catalogue/up/{id}', [CatalogueController::class, 'swapIndexUp'])->name('catalogue.index.up');
    Route::post('catalogue/down/{id}', [CatalogueController::class, 'swapIndexDown'])->name('catalogue.index.down');
